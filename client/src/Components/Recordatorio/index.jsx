...
const Recordatorio = () => {
  ...
  const enviarRecordatorio = () => {
    if (enviar.usuario.length && enviar.horario.length) {
      ...
      Notiflix.Notify.failure("Error al crear recordatorio.", {
        zindex: 9999999,
      });
  };
    ...
    <div className="containerCrono">
      <div className="containerLabelInput">
        ...
        <div className="containerInputRecor">
          ...
          <input type="time" onChange={changeValue} value={enviar.hora} />
      ...
      <div>
        <>
          {arrayRecor?.length ? (
            ...
            <div className="sinRecordatorios">
              No tenes recordatorios programados
            </div>
          )}
        </>
      </div>
