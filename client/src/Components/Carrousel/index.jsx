    ...
    return (
        <div id='carouselExample' className='carousel slide' data-ride='carousel' data-interval="5000">
            <ol className='carousel-indicators'>
                <li data-target='#carouselExample' data-slide-to='0' className='active' style={{ cursor: 'pointer' }} ></li>
                <li data-target='#carouselExample' data-slide-to='1' style={{ cursor: 'pointer' }} ></li>
            </ol>
            <div className="carousel-inner">
                <div className='carousel-item active object'>
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <button className='btn btn-success btn-lg' onClick={() => navigate('/vivero')}>Visitar vivero</button>
                    </div>
                </div>
                <div className='carousel-item object'>
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <button className='btn btn-success btn-lg' onClick={() => navigate('/huerta')}>Visitar huerta</button>
                    </div>
                </div>
            </div>
