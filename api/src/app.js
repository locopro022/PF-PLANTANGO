...
server.use((req, res, next) => {
  res.header("Access-Control-Allow-Origin", "https://plantango.vercel.app/"); // update to match the domain you will make the request from// update to match the domain you will make the request from
